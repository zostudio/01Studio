...
public class CouponBrowserApplicationTests {
    ...
    public void whenQuerySuccess() throws Exception {
        String result = mockMvc.perform(
                get("/user").param("username", "joker").param("age", "18").param("ageTo", "60").param("xxx", "yyy")
                        // .param("size", "15")
                        // .param("page", "3")
                        // .param("sort", "age,desc")
    ...
    public void whenGetInfoSuccess() throws Exception {
        String result = mockMvc.perform(get("/user/1")
                .contentType(MediaType.APPLICATION_JSON_UTF8))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.username").value("joker"))
                .andReturn().getResponse().getContentAsString();
    ...
    public void whenCreateSuccess() throws Exception {
        ...
        String content = "{\"username\":\"joker\",\"password\":null,\"birthday\":"+date.getTime()+"}";
...
//				.andExpect(jsonPath("$.id").value("1"))
    ...
    public void whenUpdateSuccess() throws Exception {
        ...
        System.out.println(date.getTime());
        String content = "{\"id\":\"1\", \"username\":\"joker\",\"password\":null,\"birthday\":"+date.getTime()+"}";
